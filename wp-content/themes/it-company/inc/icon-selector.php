...
class IT_Company_Icon_Selector extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                  ...
                  <ul class="icon-list">
                    ...
                    <?php
                    $it_company_font_awesome_icon_array = it_company_font_awesome_icon_array();
                    foreach ($it_company_font_awesome_icon_array as $it_company_font_awesome_icon) {
                            $icon_class = $this->value() == $it_company_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($it_company_font_awesome_icon).'"></i>
                            <span class="it-company-social-class">'.esc_attr($it_company_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function it_company_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'it_company_customizer_script' );

if(!function_exists('it_company_font_awesome_icon_array')){
    function it_company_font_awesome_icon_array(){
