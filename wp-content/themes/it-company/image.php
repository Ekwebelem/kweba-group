...
<div class="container">
    <main id="maincontent" role="main" class="main-wrap-box">
        ...
        if($it_company_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                            ...
                            <div class="entry-content">
                                ...
                                <div class="entry-attachment">
                                    <div class="attachment">
                                        <?php it_company_the_attached_image(); ?>
                                    </div>
                                ...
                                <?php
                                    the_content();
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'it-company' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div>    
                            <?php edit_post_link( __( 'Edit', 'it-company' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
        ...
        <?php }else if($it_company_left_right == 'Right Sidebar'){ ?>
            <div class="row">
                <div class="col-lg-9 col-md-9" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div id="wrapper">
                <?php while ( have_posts() ) : the_post(); ?>    
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <?php edit_post_link( __( 'Edit', 'it-company' ), '<footer class="entry-meta"><span role="contentinfo" class="edit-link">', '</span></footer>' ); ?>
                    </article>    
                    <?php
                        // If comments are open or we have at least one comment, load up the comment template
                        if ( comments_open() || '0' != get_comments_number() )
